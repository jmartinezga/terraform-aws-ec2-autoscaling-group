...
variable "asg_max_size" {
  ...
  validation {
    ...
    error_message = "Autoscaling Group max size should be a number."
  }
}
variable "asg_min_size" {
  ...
  validation {
    ...
    error_message = "Autoscaling Group min size should be a number."
  }
}
...
variable "asg_desired_capacity" {
  ...
  validation {
    ...
    error_message = "Autoscaling Group desired capacity should be a number."
  }
}
